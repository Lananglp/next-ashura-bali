    ...
    return (
        <>  
            ...
            <AnimatePresence mode='wait'>
                {!open &&
                    <div className='md:h-screen md:flex md:justify-center md:items-center overflow-hidden px-0 md:px-8 lg:px-32 xl:px-64 md:py-20 lg:py-32'>
                        <div className='relative w-full'>
                            <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.5, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '-30px', translateY: '-30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 0.6, duration: 1.5 }} className='hidden md:block absolute z-0 -start-16 -top-16'>
                                <Image priority src='/image/border-t-l.svg' alt='flower.svg' width={0} height={0} className='h-44 w-44'/>
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.5, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '30px', translateY: '-30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 0.6, duration: 1.5 }} className='hidden md:block absolute z-0 -end-16 -top-16'>
                                <Image priority src='/image/border-t-r.svg' alt='flower.svg' width={0} height={0} className='h-44 w-44' />
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.5, translateX: '0px' }} exit={{ opacity: 0, translateX: '30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 0.8, duration: 1.5 }} className='hidden md:block absolute z-0 -start-32 bottom-32'>
                                <Image priority src='/image/flower-r.svg' alt='flower.svg' width={0} height={0} className='h-32 w-32' />
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.5, translateX: '0px' }} exit={{ opacity: 0, translateX: '-30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 0.8, duration: 1.5 }} className='hidden md:block opacity-50 absolute z-0 -end-32 bottom-32'>
                                <Image priority src='/image/flower-l.svg' alt='flower.svg' width={0} height={0} className='h-32 w-32' />
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px' }} exit={{ opacity: 0, translateX: '-30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 1, duration: 1.5 }} className='hidden md:block absolute z-10 -bottom-4 -end-32 rotate-45'>
                                <Image priority src='/image/flower-r-3.svg' alt='flower.svg' width={0} height={0} className='h-44 w-44' />
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px' }} exit={{ opacity: 0, translateX: '30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 1, duration: 1.5 }} className='hidden md:block absolute z-10 -bottom-4 -start-32 -rotate-45'>
                                <Image priority src='/image/flower-l-3.svg' alt='flower.svg' width={0} height={0} className='h-44 w-44' />
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '-50%', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.5, translateX: '-50%', translateY: '0px' }} exit={{ opacity: 0, translateX: '-50%', translateY: '-30px' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 1.2, duration: 1.5 }} className='hidden md:block opacity-50 absolute z-0 -bottom-40 start-1/2'>
                                <Image priority src='/image/decoration-2.svg' alt='flower.svg' width={0} height={0} className='h-56 w-56' />
                            </motion.div>
                            <motion.div initial={{ opacity: 0, translateX: '-50%', translateY: '30px', rotate: '180deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.5, translateX: '-50%', translateY: '0px', rotate: '180deg' }} exit={{ opacity: 0, translateX: '-50%', translateY: '30px', rotate: '180deg' }} transition={{ type: 'spring', bounce: 0.5, ease: 'easeInOut', delay: 1.2, duration: 1.5 }} className='hidden md:block opacity-50 absolute z-0 -top-40 start-1/2'>
                                <Image priority src='/image/decoration-2.svg' alt='flower.svg' width={0} height={0} className='h-56 w-56' />
                            </motion.div>
                            <motion.div 
                            ...
                            >
                                <motion.div initial={{ opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 1, duration: 1.5 }} className='md:basis-6/12 xl:basis-5/12 overflow-hidden absolute md:relative inset-0 md:rounded-e-xl'>
                                ...
                                <div className='md:basis-6/12 xl:basis-7/12 overflow-hidden absolute md:relative z-20 inset-0 flex justify-center items-center bg-black/50 text-yellow-100'>
                                    <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '-30px', rotate: '3deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '3deg' }} exit={{ opacity: 0, translateX: '-30px', translateY: '-30px', rotate: '3deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 1.5 }} className='absolute z-0 start-2 top-4'>
                                        <Image priority src='/image/border-t-l.svg' alt='flower.svg' width={0} height={0} className='h-32 w-32' />
                                    </motion.div>
                                    <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '-30px', rotate: '-3deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '-3deg' }} exit={{ opacity: 0, translateX: '30px', translateY: '-30px', rotate: '-3deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 1.5 }} className='absolute z-0 end-2 top-4'>
                                        <Image priority src='/image/border-t-r.svg' alt='flower.svg' width={0} height={0} className='h-32 w-32' />
                                    </motion.div>
                                    <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '-30px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 1.5 }} className='absolute z-0 start-2 bottom-2'>
                                        <Image priority src='/image/border-b-l.svg' alt='flower.svg' width={0} height={0} className='h-32 w-32' />
                                    </motion.div>
                                    <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '30px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 1.5 }} className='absolute z-0 end-2 bottom-2'>
                                    ...
                                    <div className='text-center'>
                                        <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.9, duration: 1.5 }} className='mb-2 tracking-wide text-yellow-100 font-light text-base md:text-sm xl:text-xl'>Pawiwahan</motion.p>
                                        <motion.h2 initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.8, duration: 1.5 }} className={`${birthstone.className} mb-4 text-5xl md:text-3xl xl:text-5xl text-yellow-200`}>Sing &amp; Tawang</motion.h2>
                                        <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.7, duration: 1.5 }} className='inline-block md:hidden mx-auto w-72 mb-2 text-sm'>Kami akan segera melangsungkan (Jenis acara) pada:</motion.p>
                                        <motion.div initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.6, duration: 1.5 }}>
                                            <DateCountdown tanggalAcara={tanggalAcara}/>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.5, duration: 1.5 }}>
                                            <Image priority src='/image/decoration-2.svg' alt='flower.svg' width={0} height={0} className='h-auto w-56 mx-auto mt-2' />
                                        </motion.div>
                                        <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.4, duration: 1.5 }} className='mx-auto w-72 mb-2'>Kepada Yth:</motion.p>
                                        <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.3, duration: 1.5 }} className='mx-auto w-72 text-xl mb-4'>I Gede Sing Tawang</motion.p>

                                        <motion.div initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} exit={{ opacity: 0, translateX: '0px', translateY: '30px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.2, duration: 1.5 }} className='inline-block relative'>
                    ...
                    >
                        <div className='overflow-hidden px-0 md:px-8 lg:px-32 xl:px-64 md:pt-20 lg:pt-32'>
                            <div className='relative'>
                                ...
                                <motion.div initial={{ opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 2 }} className='md:flex md:flex-row-reverse bg-gradient-to-b from-transparent to-yellow-300/5 from-[65%] md:from-[0%] to-[100%] md:border md:border-yellow-300/15 overflow-hidden md:shadow-xl md:shadow-yellow-300/5 rounded-xl md:md:mb-32'>
                                    <div className='md:basis-6/12 xl:basis-5/12 relative md:border-s border-yellow-300/15'>
                                        <motion.div initial={{ opacity: 0, zIndex: '10' }} viewport={{ once: true }} whileInView={{ opacity: 1, zIndex: '10' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 2.8, duration: 1.5 }} className='block md:hidden absolute inset-0 bg-gradient-to-t from-transparent to-black/75 from-[70%] to-[100%]'/>
                                        <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '-30px', rotate: '6deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '6deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 1.2, duration: 1.5 }} className='block md:hidden absolute z-20 -top-4 -start-8'>
                                            <Image src='/image/flower-l-3.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '-30px', rotate: '-6deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '-6deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 1.2, duration: 1.5 }} className='block md:hidden absolute z-20 -top-4 -end-8'>
                                            <Image src='/image/flower-r-3.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0, translateX: '0px', translateY: '-30px', zIndex: '20' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px', zIndex: '20' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 1.2, duration: 1.5 }} className='block md:hidden absolute inset-x-0 top-6'>
                                            <Image src='/image/decoration-1.svg' alt='Image1' width={0} height={0} className='mx-auto w-40 h-auto opacity-75'/>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1 }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.7, duration: 1.5 }}>
                                    ...
                                    <div className='md:basis-6/12 xl:basis-7/12 relative md:flex md:justify-center md:items-center px-4 py-12'>
                                        <div>
                                            <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '-30px', rotate: '6deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '6deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.6, duration: 1.5 }} className='hidden md:block absolute -top-4 -start-8'>
                                                <Image src='/image/flower-l-3.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                            </motion.div>
                                            <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '-30px', rotate: '6deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '6deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.6, duration: 1.5 }} className='hidden md:block absolute -top-4 -end-8'>
                                                <Image src='/image/flower-r-3.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                            </motion.div>
                                            <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.5, duration: 1.5 }} className='absolute bottom-0 start-0'>
                                                <Image src='/image/flower-l-2.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                            </motion.div>
                                            <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '30px' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.5, duration: 1.5 }} className='absolute bottom-0 end-0'>
                                            ...
                                            <div className='absolute md:static inset-x-0 -top-16 text-center md:px-12'>
                                                <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.4, duration: 1.5 }} className='mb-2 tracking-wide text-yellow-100 font-light text-base md:text-sm xl:text-xl'>Pawiwahan</motion.p>
                                                <motion.h1 initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.3, duration: 1.5 }} className={`${birthstone.className} mb-4 text-5xl md:text-3xl xl:text-5xl text-yellow-200`}>My Name &amp; Unkown</motion.h1>
                                            </div>
                                            <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.2, duration: 1.5 }} className='px-8 md:px-4 xl:px-12 italic tracking-wide text-yellow-100 text-center font-light text-sm'>&quot; Ihaiva stam mā vi yaustam, Visvām āyur vyasnutam. Krindantau putrair naptrbhih, Modamānau sve grhe. &quot;</motion.p>
                                            <motion.div initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0.1, duration: 1.5 }} className='my-6 mx-auto w-56 border-b border-zinc-800' />
                                            <motion.p initial={{ opacity: 0, translateX: '0px', translateY: '-30px' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 1.5 }} className='mb-4 xl:mb-0 px-12 md:px-6 xl:px-12 tracking-wide font-light text-center text-sm'>Wahai pasangan suami-isteri, semoga kalian tetap bersatu dan tidak pernah terpisahkan. Semoga kalian mencapai hidup penuh kebahagiaan, tinggal di rumah yang penuh kegembiraan bersama seluruh keturunanmu.</motion.p>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
