                            ...
                            <div className='relative'>
                                ...
                                <motion.div initial={{ opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 0, duration: 2 }} className='md:flex md:flex-row-reverse bg-gradient-to-b from-transparent to-yellow-300/5 from-[65%] md:from-[0%] to-[100%] md:border md:border-yellow-300/15 overflow-hidden md:shadow-xl md:shadow-yellow-300/5 rounded-xl md:md:mb-32'>
                                    <div className='md:basis-6/12 xl:basis-5/12 relative md:border-s border-yellow-300/15'>
                                        ...
                                        <motion.div initial={{ opacity: 0, translateX: '-30px', translateY: '-30px', rotate: '6deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '6deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 2.8, duration: 1.5 }} className='block md:hidden absolute z-20 -top-4 -start-8'>
                                            <Image src='/image/flower-l-3.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0, translateX: '30px', translateY: '-30px', rotate: '-6deg' }} viewport={{ once: true }} whileInView={{ opacity: 0.75, translateX: '0px', translateY: '0px', rotate: '-6deg' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 2.8, duration: 1.5 }} className='block md:hidden absolute z-20 -top-4 -end-8'>
                                            <Image src='/image/flower-r-3.svg' alt='Image1' width={0} height={0} className='w-36 h-36'/>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0, translateX: '0px', translateY: '-30px', zIndex: '10' }} viewport={{ once: true }} whileInView={{ opacity: 1, translateX: '0px', translateY: '0px', zIndex: '10' }} transition={{ type: 'spring', bounce: 0, ease: 'easeInOut', delay: 2.8, duration: 1.5 }} className='block md:hidden absolute inset-x-0 top-6'>
